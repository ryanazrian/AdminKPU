<?php 
    include '../admin_kpu/post_get.php'
?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="#">
                            <i class="fa fa-dashboard"></i> Sosialisasi Cagub</a>
                    </li>
                    <li class="active">Berita Pemilu</li>
                </ol>
            </section>
