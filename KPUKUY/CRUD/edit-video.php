...
mysql_select_db($database) or die ("Database tidak tersedia");
    ...
    $id = $_GET['id'];
    $data = mysql_query("SELECT * FROM video WHERE id='$id'");
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="../admin_kpu/video_update.php" name="modal-popup" enctype="multipart/form-data" method="POST" id="form-edit">
